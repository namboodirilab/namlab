...
unsigned long solenoidmanual[numCS];        // solenoid open time for manual - for calibration purpose
...
void getParams() {
  int pn = 162;                              // number of parameter inputs
  ...
  solenoidmanual[0]              = param[158];
  solenoidmanual[1]              = param[159];
  solenoidmanual[2]              = param[160];
  solenoidmanual[3]              = param[161];
