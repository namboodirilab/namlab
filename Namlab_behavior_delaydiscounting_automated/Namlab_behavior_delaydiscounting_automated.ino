...
unsigned long minrewards[numlicktube];        // number of rewards for each reward magnitude, the total reward num would be 7*this number
...
void getParams() {
  ...
  if (fixedsidecheck[0] == 1) {
    varyingside = 1;
  }
  else if (fixedsidecheck[1] == 1) {
    varyingside = 0;
  }
