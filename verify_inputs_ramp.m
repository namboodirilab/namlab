    ...
    cueramp = [str2double(split(data(12,1),'/'))',str2double(split(data(12,2),'/'))',str2double(split(data(12,3),'/'))',...
                str2double(split(data(12,4),'/'))',str2double(split(data(12,5),'/'))'];
    ISI = cell2mat(data(13,:));
    laserpulse = [str2double(split(data(14,1),'/'))',str2double(split(data(14,2),'/'))',str2double(split(data(14,3),'/'))',...
                    str2double(split(data(14,4),'/'))',str2double(split(data(14,5),'/'))',str2double(split(data(14,6),'/'))'];       %cell2mat(data(13,:));
    laserdelay = cell2mat(data(15,:));
    laserdur = cell2mat(data(16,:));
    ...
    inputs = [cueprob,cuetype,cuefreq,cuesource,cuedur,cuepulse,cueramp,ISI,laserpulse,...
